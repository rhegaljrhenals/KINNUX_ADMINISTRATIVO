<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfConceptoGastos.aspx.vb" Inherits="Basicos_wfSucursale" %>
          ...
          <td width="5%" align="center">
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" Height="40px" 
                ...
                Width="40px" />
                          ...
                          <td width="90%">Concepto De Gastos</td>
            </tr>
          </table></td>
      </tr>
    </table>
                ...
                <table cellpadding="2" class="style1">
                    ...
                    <tr>
                        <td class="style12" align="left">
                            Nombre Gasto:</td>
                        <td align="left">
                            <asp:TextBox ID="TextBox2" runat="server" Width="228px" CssClass="campver"></asp:TextBox>
                            ...
                            <asp:Panel ID="Panel2" runat="server" BorderStyle="None" Height="400px" 
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="idconceptogasto" HeaderText="Id" />
                                        <asp:BoundField DataField="nombreconceptogasto" HeaderText="Nombre Concepto" />
                                        <asp:BoundField DataField="estado" HeaderText="Nombre Estado" />
                                    </Columns>
