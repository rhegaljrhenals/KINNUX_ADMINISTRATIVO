<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wflineaArticulo.aspx.vb" Inherits="Seguridad_wfGrupoUsuario" %>
      ...
      <tr>
        <td class="titleseccion"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="5%" align="center">
                                                    ...
                                                    &nbsp;</td>
                          <td width="90%">Lineas De Articulos</td>
            </tr>
          </table></td>
      </tr>
    </table>
                ...
                <table cellpadding="2" class="style1" style="width: 100%">
                    ...
                    <tr>
                        <td align="left" class="style6" colspan="2">
                            <asp:Label ID="Label9" runat="server" style="color: #003300; font-weight: 700"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:Panel ID="Panel3" runat="server" Height="300px" ScrollBars="Both">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="idLinea" HeaderText="Codigo Linea" />
