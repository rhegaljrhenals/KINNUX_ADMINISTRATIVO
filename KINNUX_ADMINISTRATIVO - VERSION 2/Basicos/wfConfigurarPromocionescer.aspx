<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfConfigurarPromocionescer.aspx.vb" Inherits="Basicos_wfProducto" %>
      ...
      <tr>
        <td class="titleseccion"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="5%" align="center">
                          ...
                          <td width="90%">Configurar Promociones Cerradas</td>
            </tr>
          </table></td>
      </tr>
    </table>
                                                            ...
                                                            <td>
                                                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Obsequio">
                                                                            <ItemTemplate>
