<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfEmpresa.aspx.vb" Inherits="Basicos_wfEmpresa" %>
                ...
                <table cellpadding="2" class="style1" style="width: 100%">
                    ...
                    <tr>
                        <td class="style10" align="left">
                            Pais:</td>
                        <td align="left">
                            <asp:DropDownList ID="DropDownList2" runat="server" Width="350px" CssClass="campver">
                            </asp:DropDownList>
                            &nbsp;<asp:ImageButton ID="ImageButton6" runat="server" Height="30px" 
                                ImageUrl="~/Imagenes/buscar.png" ToolTip="Empresas Por Pais" 
                                Width="30px" />
                    ...
                    <tr>
                        <td align="left" class="style10">
                            Estado:</td>
                        <td align="left">
                            <asp:DropDownList ID="DropDownList1" runat="server" Width="228px" CssClass="campver">
                    ...
                    <tr>
                        <td align="left" class="style10" colspan="2">
                            <asp:Label ID="Label7" runat="server" style="color: #003300; font-weight: 700;" 
                            ...
                            <asp:Panel ID="Panel3" runat="server" Height="400px" ScrollBars="Vertical">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="telefonoEmpresa" HeaderText="Telefono" />
                                        <asp:BoundField DataField="representanteEmpresa" HeaderText="Representante" />
                                        <asp:BoundField DataField="codigoPais" HeaderText="Id Pais" />
                                        <asp:BoundField DataField="nombrepais" HeaderText="Nombre Pais" />
                                        <asp:BoundField DataField="estadoEmpresa" HeaderText="Estado Empresa" />
                                    </Columns>
