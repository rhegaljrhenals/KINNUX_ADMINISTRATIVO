<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfEntrada.aspx.vb" Inherits="Paises_wfEntrada" %>
                                                ...
                                                <table cellpadding="2" class="style1">
                                                    ...
                                                    <tr>
                                                        <td class="style20">
                                                            Numero De Pedido:</td>
                                                        <td>
                                                            <asp:TextBox ID="TextBox27" runat="server" style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td style="color: #000066; font-weight: 700">
                                                            &#160;</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style20">
                                                            Proveeedores:</td>
                                                        <td colspan="3">
                                                            <asp:DropDownList ID="DropDownList23" runat="server" Width="220px">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <table cellpadding="2" class="style1">
                                                    ...
                                                    <tr>
                                                        <td class="style20">
                                                            Id Entrada:</td>
                                                        <td>
                                                            <asp:TextBox ID="TextBox46" runat="server" CssClass="style20" ReadOnly="True" 
                                                                style="margin-left: 0px" Width="75px"></asp:TextBox>
                                                        </td>
                                                        <td style="color: #000066; font-weight: 700">
                                                            &#160;Numero:</td>
                                                        <td>
                                                            <asp:TextBox ID="TextBox47" runat="server" ReadOnly="True" 
                                                                style="font-weight: 700; color: #FF0000; text-align: right" Width="100px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="style20">
                                                            Numero De Pedido:</td>
                                                        <td colspan="3">
                                                            <asp:TextBox ID="TextBox48" runat="server" style="text-align: right"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="style20">
                                                            Proveedores:</td>
                                                        <td colspan="3">
                                                            <asp:DropDownList ID="DropDownList26" runat="server" Width="220px">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            ...
                                                            <asp:FilteredTextBoxExtender ID="TextBox49_FilteredTextBoxExtender" 
                                                                runat="server" Enabled="True" FilterType="Numbers" TargetControlID="TextBox49">
                                                            </asp:FilteredTextBoxExtender>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
<ContentTemplate>
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                    ...
                                    <table cellpadding="2" class="style1">
                                        <tr>
                                            <td bgcolor="#CCCCCC" colspan="4">
                                                <asp:ImageButton ID="ImageButton28" runat="server" Height="50px" 
                                                    ImageUrl="~/Imagenes/nuevo.png" ToolTip="Nuevo" Width="50px" />
                                                <asp:ImageButton ID="ImageButton29" runat="server" Height="50px" 
                                                    ImageUrl="~/Imagenes/guardar.png" ToolTip="Grabar" Width="50px" />
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <asp:FilteredTextBoxExtender ID="TextBox50_FilteredTextBoxExtender" 
                                                    runat="server" Enabled="True" FilterType="Numbers" TargetControlID="TextBox50">
                                                </asp:FilteredTextBoxExtender>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style20">
                                                Proveeedores:</td>
                                            <td colspan="3">
                                                <asp:DropDownList ID="DropDownList29" runat="server" Width="220px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <asp:FilteredTextBoxExtender ID="TextBox51_FilteredTextBoxExtender" 
                                                    runat="server" Enabled="True" FilterType="Numbers" TargetControlID="TextBox51">
                                                </asp:FilteredTextBoxExtender>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="ImageButton28" EventName="Click" />
                                    <asp:AsyncPostBackTrigger ControlID="ImageButton29" EventName="Click" />
                                </Triggers>
                            </asp:UpdatePanel>
                                        ...
                                        <tr>
                                            <td bgcolor="#CCCCCC">
                                                <asp:ImageButton ID="ImageButton25" runat="server" Height="50px" 
                                                    ImageUrl="~/Imagenes/productos.png" ToolTip="Entradas De Productos" 
                                                    Width="50px" />
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table cellpadding="2" class="style1">
                                                                        <tr>
                                                                            <td class="style20">
                                                                                <asp:Button ID="Button4" runat="server" Text="Consulta General" 
                                                                    ...
                                                                    <asp:Panel ID="Panel4" runat="server" Height="650px" ScrollBars="Both">
                                                                        <asp:GridView ID="GridView9" runat="server" AutoGenerateColumns="False" 
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="idEncabezadoEntrada" HeaderText="Id" />
                                                                                <asp:BoundField DataField="codigoEncabezadoEntrada" HeaderText="Numero" />
                                                                                <asp:BoundField DataField="idEncabezadoPedido" HeaderText="Pedido" />
                                                                                ...
                                                                                <asp:BoundField DataField="fechaEncabezadoEntrada" 
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table cellpadding="2" class="style1">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Button ID="Button5" runat="server" Text="Consulta General" 
                                                                                    ToolTip="Consulta Por Pais" />
                                                                            </td>
                                                                            <td>
                                                                                &#160;</td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table cellpadding="2" class="style1">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Button ID="Button9" runat="server" Text="Consulta General" 
                                                                                    ToolTip="Consulta Por Pais" />
                                                                            </td>
                                                                            <td>
                                                                                &#160;</td>
