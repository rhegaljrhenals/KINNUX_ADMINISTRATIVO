...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <tr>
            <td align="left" colspan="2">
                <table cellpadding="0" cellspacing="0" class="style1">
                    ...
                    <tr>
                        <td>
                            <asp:DropDownList ID="DropDownList1" runat="server" Width="300px" style="margin-left:0px" CssClass="campver">
                            </asp:DropDownList>
                        </td>
                        <td>
                            &nbsp;</td>
    ...
    CellPadding="3" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="vpcalifeuropa" HeaderText="Volumen Personal" 
                                DataFormatString="{0:N2}" >
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="vg1califeuropa" HeaderText="Acumulado Nivel 1" DataFormatString="{0:N2}">
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="total" DataFormatString="{0:N2}" HeaderText="Vol Grupal Nivel 2">
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="nuevoscalifeuropa" HeaderText="Nuevos Afiliados" DataFormatString="{0:N0}" >
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="calificadocalifeuropa" HeaderText="Calificado" >
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="cuposeuropa" HeaderText="Cupos">
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                        </Columns>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="nombres" HeaderText="Nombres" />
                                        <asp:BoundField DataField="vpcalifeuropa" DataFormatString="{0:N2}" 
                                            HeaderText="Puntos Personales">
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="vg1califeuropa" DataFormatString="{0:N2}" HeaderText="Volumen Grupal 1" SortExpression="vg2califmexico">
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="vg2califeuropa" 
                                            HeaderText="Volumen Grupal 2 Nivel" DataFormatString="{0:N2}">
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="calificadocalifeuropa" HeaderText="Calificado" >
                                        <ItemStyle HorizontalAlign="Center" />
