...
Partial Class Reportes_Varios_wfCalificacionpuntacana
    ...
    Function mostrarDatos() As String
        ...
        With calificacionCartagena
            ...
            tabla = .obtenerDatosCalificacionpuntacana
            If tabla.Rows.Count <> 0 Then
                Me.Panel1.Visible = True
                Me.GridView2.DataSource = tabla
                Me.GridView2.DataBind()
                '
                Me.GridView2.Caption = "Calificacion Punta Cana<br>" & Me.DropDownList1.SelectedItem.Text
    ...
    Protected Sub ImageButton2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        ...
        If Me.GridView2.Rows.Count <> 0 Then
            ExportToExcel("Puntacana2017.xls", Me.GridView2)
        Else
    ...
    Sub mostrarDetalle(ByVal codigoAfiliado As String)
        ...
        With calificacionCartagena
            ...
            tabla = .obtenerDetalleAfiliadopuntacana
            If tabla.Rows.Count <> 0 Then
                Me.Panel2.Visible = True
