<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfEncuestaSistemaDigestivoControl.aspx.vb" Inherits="Reportes_wfEncuestaSistemaDigestivoControl" %>
      ...
      <tr>
        <td class="titleseccion"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="90%">Control De Encuestas</td>
            </tr>
          </table>
          </td>
      </tr>
            ...
            <td align="left">
                <table class="style4">
                    <tr>
                        ...
                        <td>
                            <asp:RadioButton ID="RadioButton1" runat="server" GroupName="1" Text="Encuesta Sistema Digestivo" />
                            <br />
                            <asp:RadioButton ID="RadioButton2" runat="server" GroupName="1" Text="Encuesta Sistema Circulatorio" />
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style1">Codigo De Afiliado:</td>
                        <td>
