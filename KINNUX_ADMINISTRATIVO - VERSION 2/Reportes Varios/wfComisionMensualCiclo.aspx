<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfComisionMensualCiclo.aspx.vb" Inherits="Reportes_Varios_wfComisionMensual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    CellPadding="3" AutoGenerateColumns="False" ShowFooter="True" ShowHeaderWhenEmpty="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="escalonadocomisionciclo" HeaderText="Escalonado" 
                                DataFormatString="{0:N2}" >
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ciclocomisionciclo" HeaderText="Bono Ciclo" 
                                DataFormatString="{0:N2}" >
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
