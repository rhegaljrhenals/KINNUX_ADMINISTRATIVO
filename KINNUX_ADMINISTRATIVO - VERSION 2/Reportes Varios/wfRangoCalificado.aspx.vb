...
Partial Class Reportes_Varios_wfRangoCalificado
    ...
    Sub mostrarDatos()
        ...
        " end mescalificado," & _
        "TTRangoCalificado.anocalificado," & _
        "dbo.TBpais.codigoPais," & _
        "dbo.TBpais.nombrePais" & _
        " FROM" & _
        " dbo.Afiliaciones INNER JOIN" & _
        " TTRangoCalificado ON dbo.Afiliaciones.codigoAfiliado = TTRangoCalificado.codigoafiliado INNER JOIN" & _
        " dbo.TBpais ON dbo.Afiliaciones.codigoPais = dbo.TBpais.codigoPais" & _
        " where TTRangoCalificado.mescalificado=" & Me.DropDownList2.SelectedValue & " and TTRangoCalificado.anocalificado=" & Me.DropDownList3.SelectedItem.Text
    ...
    Protected Sub ImageButton2_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        If Me.GridView2.Rows.Count <> 0 Then
            ExportToExcel("RangosCalificados.xls", Me.GridView2)
        End If
    End Sub
End Class
