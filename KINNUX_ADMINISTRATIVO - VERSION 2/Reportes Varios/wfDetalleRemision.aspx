<%@ Page Language="VB" AutoEventWireup="false" CodeFile="wfDetalleRemision.aspx.vb" Inherits="Reportes_Varios_wfCompras" %>
          ...
          <tr>
            <td width="5%" align="center">
                ...
                <br />
                          ...
                          <td width="90%">Detalle De La Remision</td>
            </tr>
          </table></td>
      </tr>
    </table>
                ...
                <table cellpadding="0" cellspacing="0" class="style1" style="width: 450px">
                    ...
                    <tr>
                        <td class="style16">
                            Fecha:</td>
                        <td colspan="3">
                            <asp:TextBox ID="TextBox3" runat="server" ReadOnly="True" CssClass="campver"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style16">
                            Puntos:</td>
                        <td>
                            <asp:TextBox ID="TextBox9" runat="server" ReadOnly="True" Width="80px" 
                                CssClass="campver"></asp:TextBox>
                        </td>
                        <td style="color: #003366">
                            No De Ts:</td>
                        <td>
                            <asp:TextBox ID="TextBox40" runat="server" ReadOnly="True" Width="80px" 
                                CssClass="campver"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style16">
                            Afiliado:</td>
                        <td colspan="3">
                            <asp:TextBox ID="TextBox4" runat="server" ReadOnly="True" Width="60px" 
                                CssClass="campver"></asp:TextBox>
                            <asp:TextBox ID="TextBox5" runat="server" ReadOnly="True" Width="250px" 
                                CssClass="campver"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style16">
                            Empresa:</td>
                        <td colspan="3">
                            <asp:TextBox ID="TextBox31" runat="server" ReadOnly="True" Width="60px" 
                                CssClass="campver"></asp:TextBox>
                            <asp:TextBox ID="TextBox6" runat="server" ReadOnly="True" Width="250px" 
                                CssClass="campver"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style16">
                            Sucursal:</td>
                        <td colspan="3">
                            <asp:TextBox ID="TextBox32" runat="server" ReadOnly="True" Width="60px" 
                                CssClass="campver"></asp:TextBox>
                    ...
                    <tr>
                        <td class="style16">
                            Usuario:</td>
                        <td colspan="3">
                            <asp:TextBox ID="TextBox30" runat="server" ReadOnly="True" Width="200px" 
                                CssClass="campver"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style16">
                            Estado:</td>
                        <td colspan="3">
                            <asp:TextBox ID="TextBox33" runat="server" ReadOnly="True" CssClass="campver"></asp:TextBox>
                        </td>
                    </tr>
                    </table>
            </td>
                    ...
                    <table cellpadding="0" cellspacing="0" class="style1" style="width: 100%">
                        ...
                        <tr>
                            <td class="style16">
                                Patrocinador:</td>
                            <td>
                                <asp:TextBox ID="TextBox34" runat="server" ReadOnly="True" Width="60px" 
                                    CssClass="campver"></asp:TextBox>
                                <asp:TextBox ID="TextBox35" runat="server" ReadOnly="True" Width="250px" 
                                    CssClass="campver"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style16">
                                Estado Comision:</td>
                            <td>
                                <asp:TextBox ID="TextBox36" runat="server" ReadOnly="True" CssClass="campver"></asp:TextBox>
                                &nbsp;Valor Comision:
                                <asp:TextBox ID="TextBox37" runat="server" ReadOnly="True" 
                                    style="text-align: right" Width="70px" CssClass="campver"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style16">
                                Fecha Pago:</td>
                            <td>
                                <asp:TextBox ID="TextBox38" runat="server" ReadOnly="True" CssClass="campver"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style16">
                                Usuario Que Pagó:</td>
                            <td>
                                <asp:TextBox ID="TextBox39" runat="server" ReadOnly="True" Width="250px" 
                                    CssClass="campver"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
        ...
        <tr>
            <td align="left" colspan="2">
                            <asp:Panel ID="Panel3" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" 
                                BorderWidth="1px" Height="150px" ScrollBars="Vertical">
                                <table cellpadding="0" cellspacing="0" class="style1">
                                    <tr>
                                        <td align="center" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBox21" runat="server" ReadOnly="True" 
                                                style="text-align: right" Width="50px" CssClass="campver"></asp:TextBox>
                                            <asp:TextBox ID="TextBox24" runat="server" ReadOnly="True" 
                                                style="text-align: right" Width="100px" CssClass="campver"></asp:TextBox>
                                            <asp:TextBox ID="TextBox27" runat="server" ReadOnly="True" 
                                                style="text-align: right" Width="120px" CssClass="campver"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style16">
