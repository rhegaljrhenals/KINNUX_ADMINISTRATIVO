    ...
    Sub mostrarDatos()
        ...
        With encabezadoFacturas
            ...
            Else
                .idSucursal = 0
            End If
            titulo = Me.DropDownList13.SelectedItem.Text & " " & Me.DropDownList14.SelectedItem.Text & " De " & Me.DropDownList12.SelectedItem.Text & " - " & Me.DropDownList16.SelectedItem.Text & " " & Me.DropDownList17.SelectedItem.Text & " De " & Me.DropDownList15.SelectedItem.Text
            If Me.CheckBox1.Checked = True Then
