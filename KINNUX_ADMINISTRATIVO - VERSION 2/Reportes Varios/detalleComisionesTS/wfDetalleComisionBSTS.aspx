<%@ Page Language="VB" AutoEventWireup="false" CodeFile="wfDetalleComisionBSTS.aspx.vb" Inherits="wfReporteDetalleComisionIR" %>
                        ...
                        Height="232px" ID="Panel7" Width="650px">
                                                        <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="False" 
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="numtsdetcomisionbsts" HeaderText="Numero TS" 
                                                                    DataFormatString="{0:N0}" >
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="pagoxtsdetcomisionbsts" HeaderText="Pago x STS" 
                                                                    DataFormatString="{0:N2}" >
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="valordetcomisionbsts" HeaderText="Valor" 
                                                                    DataFormatString="{0:N0}" >
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                </asp:BoundField>
                                                            </Columns>
