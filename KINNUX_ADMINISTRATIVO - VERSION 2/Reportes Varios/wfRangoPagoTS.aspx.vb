...
Partial Class Reportes_Varios_wfComisionMensual
    ...
    Sub cargarDpto()
        ...
        " FROM" & _
        " TTRangopagots INNER JOIN" & _
        " dbo.Afiliaciones ON TTRangopagots.codigoafiliado = dbo.Afiliaciones.codigoAfiliado INNER JOIN" & _
    ...
    Sub cargarMunicipio()
        ...
        " TTRangopagots ON dbo.Afiliaciones.codigoAfiliado = TTRangopagots.codigoafiliado INNER JOIN" & _
        " dbo.TBpais ON dbo.Afiliaciones.codigoPais = dbo.TBpais.codigoPais INNER JOIN" & _
    ...
    Sub cargarEmpresas()
        ...
        With operaciones
            ...
            Else
                ...
                Me.DropDownList1.DataBind()
            End If
            Me.DropDownList1.Items.Insert(0, "Toodas las empresas")
        End With
    End Sub
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        Else
            ...
            " case TTRangopagots.rangopagots" & _
            ...
            " else ''" & _
            " end Rango," & _
            " case TTRangopagots.mesrangopagots" & _
            " when 1 then 'Enero'" & _
            ...
            " end mes," & _
            " TTRangopagots.anorangopagots," & _
            " TTRangopagots.tsrangopagots," & _
            ...
            " dbo.TBMunicipio ON dbo.Afiliaciones.codigoPais = dbo.TBMunicipio.idPais AND dbo.Afiliaciones.codigoDpto = dbo.TBMunicipio.idDpto AND " & _
            " dbo.Afiliaciones.codigoCiudad = dbo.TBMunicipio.codigoMunicipio" & _
            " where TTRangopagots.mesrangopagots=" & Me.DropDownList13.SelectedValue & " and" & _
            " TTRangopagots.anorangopagots=" & Me.DropDownList12.SelectedItem.Text
