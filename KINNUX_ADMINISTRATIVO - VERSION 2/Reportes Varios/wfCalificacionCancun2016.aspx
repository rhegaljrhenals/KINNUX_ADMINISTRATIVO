<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfCalificacionCancun2016.aspx.vb" Inherits="Reportes_Varios_wfCalificacionCancun2016" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <tr>
        <td class="titleseccion"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="90%">Calificación Cancun</td>
            </tr>
          </table>
          </td>
      </tr>
                        ...
                        <tr>
                            <td align="center" 
                                ...
                                <asp:Label ID="Label5" runat="server" 
                                    ...
                                    style="color: #000000; font-size: small; font-weight: 700; font-family: 'Courier New', Courier, monospace">Encabezado Calificación Cancun</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
    ...
    CellPadding="3" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="vpcalifcancun" HeaderText="Volumen Personal" 
                                DataFormatString="{0:N2}" >
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="vg1califcancun" HeaderText="Acumulado Nivel 1">
                            </asp:BoundField>
                            <asp:BoundField DataField="calificadocalifcancun" HeaderText="Calificado">
                            </asp:BoundField>
                            <asp:BoundField DataField="cuposcancun" HeaderText="Cupos" >
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="agocancun" HeaderText="Compras Ago" />
                            <asp:BoundField DataField="septcalifcancun" HeaderText="Compras Sep" />
                            <asp:BoundField DataField="octcalifcancun" HeaderText="Compras Oct" />
                            <asp:BoundField DataField="novcalifcancun" HeaderText="Compras Nov" />
                            <asp:BoundField DataField="diccalifcancun" HeaderText="Compras Dic" />
                            <asp:BoundField DataField="enerocalifcancun" HeaderText="Compras Ene" />
                        </Columns>
                        ...
                        <tr>
                            <td align="center" 
                                ...
                                <asp:Label ID="Label6" runat="server" 
                                    ...
                                    style="color: #000000; font-size: small; font-weight: 700; font-family: 'Courier New', Courier, monospace">Detalle Calificacion Cancun</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="nombres" HeaderText="Nombres" />
                                        <asp:BoundField DataField="vpcalifcancun" DataFormatString="{0:N2}" 
                                            HeaderText="Volumen Personal">
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="vg1califcancun" HeaderText="Acumulado">
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="nuevocalifcancun" HeaderText="Nuevo" />
                                        <asp:BoundField DataField="agocancun" HeaderText="Compras Ago" />
                                        <asp:BoundField DataField="septcalifcancun" HeaderText="Compras Sep" />
                                        <asp:BoundField DataField="octcalifcancun" HeaderText="Compras Oct" />
                                        <asp:BoundField DataField="novcalifcancun" HeaderText="Compras Nov" />
