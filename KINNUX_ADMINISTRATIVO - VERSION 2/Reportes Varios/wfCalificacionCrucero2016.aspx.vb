...
Partial Class Reportes_Varios_wfCalificacionCrucero2016
    ...
    Function mostrarDatos() As String
        ...
        With calificacionCartagena
            ...
            tabla = .obtenerDatosCalificacionCrucero2016
            If tabla.Rows.Count <> 0 Then
                Me.Panel1.Visible = True
                Me.GridView2.DataSource = tabla
                Me.GridView2.DataBind()
                '
                Me.GridView2.Caption = "Calificacion Crecero<br>" & Me.DropDownList1.SelectedItem.Text
    ...
    Sub mostrarDetalle(ByVal codigoAfiliado As String)
        ...
        With calificacionCartagena
            ...
            tabla = .obtenerDetalleAfiliadoCrucero2016
            If tabla.Rows.Count <> 0 Then
                Me.Panel2.Visible = True
