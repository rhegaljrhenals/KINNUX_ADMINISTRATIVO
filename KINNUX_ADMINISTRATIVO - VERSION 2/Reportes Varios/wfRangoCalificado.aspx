<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfRangoCalificado.aspx.vb" Inherits="Reportes_Varios_wfRangoCalificado" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <td>
            ...
            <td width="90%">Rango Calificado</td>
            </tr>
          </table>
          </td>
      </tr>
            ...
            <td align="left" colspan="2">
                ...
                CellPadding="3" AutoGenerateColumns="False" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="rangocalificado" HeaderText="Rango Calificado" />
                                        <asp:BoundField DataField="volumencalificado" HeaderText="Volumen Calificado">
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="nombrePais" HeaderText="Pais" />
                                        <asp:BoundField DataField="mescalificado" HeaderText="Mes Calificado" />
                                        <asp:BoundField DataField="anocalificado" HeaderText="Año Calificado" />
                                    </Columns>
