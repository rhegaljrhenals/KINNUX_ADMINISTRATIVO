    ...
    Function mostrarDatos() As String
        ...
        With objTTComision
            ...
            If tabla.Rows.Count <> 0 Then
                ...
                Me.GridView2.DataBind()
                '
                Me.GridView2.Caption = "Comisiones Mensuales TS<br>" & "[Empresa: " & Me.DropDownList1.SelectedItem.Text & "] [Periodo: " & Me.DropDownList13.SelectedItem.Text & " De " & Me.DropDownList12.SelectedItem.Text & "]"
