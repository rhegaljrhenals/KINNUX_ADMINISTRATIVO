...
Partial Class Reportes_Varios_wfCompras
    ...
    Sub actualizarNombresPaquetes()
        Dim tabla As New DataTable
        Dim y As Integer
        With paquetes
            For y = 0 To Me.GridView1.Rows.Count - 1
                .idPaquete = Me.GridView1.Rows(y).Cells(11).Text
                tabla = .obtenerPaquetesPorIdPaquete
                If tabla.Rows.Count <> 0 Then
                    Me.GridView1.Rows(y).Cells(12).Text = tabla.Rows(0).Item("nombrePaquete")
                Else
