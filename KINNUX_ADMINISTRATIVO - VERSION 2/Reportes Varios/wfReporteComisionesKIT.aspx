<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfReporteComisionesKIT.aspx.vb" Inherits="Reportes_Varios_wfReporteComisionesIR" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <td>
            ...
            <td width="90%">Comisiones Bonos De Inscripción</td>
            </tr>
          </table>
          </td>
      </tr>
        ...
        <tr>
            <td align="left" colspan="2">
                <asp:Panel ID="Panel1" runat="server" Height="815px" ScrollBars="Vertical">
                    <table cellpadding="0" cellspacing="0" class="style1">
                        <tr>
                            <td align="center" style="background-color: #CCCCCC; font-weight: 700;">
