<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfCalificacionbavaro.aspx.vb" Inherits="Reportes_Varios_wfCalificacionbavaro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <tr>
        <td class="titleseccion"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="90%">Calificación Bavaro</td>
            </tr>
          </table>
          </td>
      </tr>
    ...
    CellPadding="3" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="vpcalifbavaro" HeaderText="Volumen Personal" 
                                DataFormatString="{0:N2}" >
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="vg1califbavaro" HeaderText="Acumulado Nivel 1">
                            </asp:BoundField>
                            <asp:BoundField DataField="vggencalifbavaro" HeaderText="Vol Grupal Nivel 3" />
                            <asp:BoundField DataField="ciclosbavaro" HeaderText="Num. Ciclos">
                            </asp:BoundField>
                            <asp:BoundField DataField="calificadocalifbavaro" HeaderText="Calificado" >
                            </asp:BoundField>
                            <asp:BoundField DataField="cuposbavaro" HeaderText="Cupos">
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                        </Columns>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="nombres" HeaderText="Nombres" />
                                        <asp:BoundField DataField="vpcalifbavaro" DataFormatString="{0:N2}" 
                                            HeaderText="Puntos Personales">
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="vgafilcalifbavaro" 
                                            HeaderText="Volumen Grupal 3 Nivel">
                                        <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="nuevocalifbavaro" HeaderText="Nuevo" />
                                        <asp:BoundField DataField="calificadocalifbavaro" HeaderText="Calificado" />
                                    </Columns>
