<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfDocumentosCertificaciones.aspx.vb" Inherits="Reportes_Varios_wfEstadisticasFacturacion" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <td>
            ...
            <td width="90%">Documentos Certificaciones</td>
            </tr>
          </table>
          </td>
      </tr>
        ...
        <tr>
            <td align="left" colspan="2">
                <table class="style4">
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="Id Documento:"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="style5">
                            <asp:Label ID="Label8" runat="server" Text="Direccion Documento:"></asp:Label>
                        </td>
                        <td class="style5">
                ...
                CellPadding="3" AutoGenerateColumns="False" Width="100%">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="idDocumentoCurso" HeaderText="Id Documento" />
                                                    <asp:BoundField DataField="idCurso" HeaderText="Id Curso" />
                                                    <asp:BoundField DataField="nombreCurso" HeaderText="Nombre Curso" />
                                                    <asp:BoundField DataField="dirDocumentoCurso" 
                                                        HeaderText="Direccion Documento" />
                                                </Columns>
