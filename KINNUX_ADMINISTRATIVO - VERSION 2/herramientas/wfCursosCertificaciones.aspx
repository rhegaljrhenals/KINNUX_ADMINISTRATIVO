<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfCursosCertificaciones.aspx.vb" Inherits="Reportes_Varios_wfEstadisticasFacturacion" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <td>
            ...
            <td width="90%">Cursos Certificaciones</td>
            </tr>
          </table>
          </td>
      </tr>
        ...
        <tr>
            <td align="left" colspan="2">
                <table class="style4">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="Estado Curso:"></asp:Label>
                        </td>
                        <td>
                ...
                CellPadding="3" AutoGenerateColumns="False" Width="100%">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="estadoCurso" HeaderText="Estado Curso" />
                                                </Columns>
