...
Partial Class Reportes_Varios_wfEstadisticasFacturacion
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        If Me.TextBox2.Text = "" Then
            Me.Label7.Text = "Ingrese la direccion fisica del documento...!"
            Me.TextBox2.Focus()
            Exit Sub
        End If
        '
        ...
        Else
            ...
            accion = 2
        End If
        sql = "exec sp_TTDocumentoCurso " & _
            "@idDocumentoCurso='" & id & "'," & _
            "@idCurso='" & Me.DropDownList2.SelectedValue & "'," & _
            "@dirDocumentoCurso='" & Me.TextBox2.Text & "'," & _
            "@accion='" & accion & "'"
        With operaciones
            .Accion(sql)
        End With
        nuevo()
        mostrarVentana("Documento Grabado En El Sistema")
    End Sub
    ...
    Sub mostrarDatos()
        ...
        Dim tabla As New DataTable
        sql = "SELECT     " & _
        "dbo.TTDocumentoCurso.idDocumentoCurso, dbo.TTCurso.idCurso, dbo.TTCurso.nombreCurso, dbo.TTDocumentoCurso.dirDocumentoCurso" & _
        " FROM dbo.TTDocumentoCurso INNER JOIN" & _
        " dbo.TTCurso ON dbo.TTDocumentoCurso.idCurso = dbo.TTCurso.idCurso"
        With operaciones
            tabla = .DevuelveDato(sql)
            If tabla.Rows.Count <> 0 Then
