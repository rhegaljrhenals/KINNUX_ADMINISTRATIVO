<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfTipoPreguntasCertificaciones.aspx.vb" Inherits="Reportes_Varios_wfEstadisticasFacturacion" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <td>
            ...
            <td width="90%">Tipos De Preguntas</td>
            </tr>
          </table>
          </td>
      </tr>
        ...
        <tr>
            <td align="left" colspan="2">
                <table class="style4">
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="Id Tipo Pregunta:"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="style5">
                            <asp:Label ID="Label5" runat="server" Text="Nombre Tipo Pregunta:"></asp:Label>
                        </td>
                        <td class="style5">
                ...
                CellPadding="3" AutoGenerateColumns="False" Width="100%">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="idTipoPregunta" HeaderText="Id Tipo Pregunta" />
                                                    <asp:BoundField DataField="nombreTipoPregunta" HeaderText="Nombre" />
                                                </Columns>
