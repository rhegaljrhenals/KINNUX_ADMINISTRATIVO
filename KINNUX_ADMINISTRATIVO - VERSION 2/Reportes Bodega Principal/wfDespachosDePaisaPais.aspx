<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfDespachosDePaisaPais.aspx.vb" Inherits="Reportes_wfPedidos" %>
          ...
          <tr>
            ...
            <td width="5%" align="center">
                ...
                <br />
                          ...
                          <td width="90%">&nbsp;Reporte Despachos De Pais a Pais</td>
            </tr>
          </table></td>
      </tr>
    </table>
                                            ...
                                            <td>
                                                <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="idEncDesProductoPaisPais" HeaderText="Id" />
                                                        ...
                                                        <asp:BoundField DataField="nombreRecibe" HeaderText="Empresa Que Recibe" />
                                                        <asp:BoundField DataField="confirEncDesProductoPaisPais" 
                                                            HeaderText="Confirmado" />
                                                        <asp:BoundField DataField="estadoEncdesProductoPaisPais" HeaderText="Estado" />
                                                    </Columns>
                                        ...
                                        <td>
                                            <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="valorDetDesProductoPaisPais" HeaderText="Valor" />
                                                    <asp:BoundField DataField="subtotalDetDesProductoPaisPais" 
                                                        HeaderText="Subtotal">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                    </asp:BoundField>
