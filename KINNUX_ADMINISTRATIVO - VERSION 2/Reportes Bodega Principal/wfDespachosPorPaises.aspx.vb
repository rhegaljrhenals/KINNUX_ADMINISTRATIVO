...
Partial Class Reportes_wfPedidos
    ...
    Dim encabezadoDespacho As New clsTTEncDesProductoPunto
    Dim detalleDespacho As New clsTTDetDesProductoPunto
    ...
    Sub mostrarDetalleDespacho(ByVal idPedido As Integer)
        ...
        With detalleDespacho
            .idEncDesProductoPunto = idPedido
            tabla = .obtenerDetalledespachoPorEmpresa
            If tabla.Rows.Count <> 0 Then
