<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="wfMovimientosProductos.aspx.vb" Inherits="Reportes_Bodega_Principal_wfMovimientosProductos" %>
        ...
        <td class="titleseccion"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="5%" align="center">&nbsp;<asp:ImageButton ID="ImageButton7" 
                ...
                <br />
                          ...
                          <td width="90%">Movimientos De Productos Empresas</td>
            </tr>
          </table></td>
      </tr>
    </table>
                            ...
                            <tr __designer:mapid="8c5">
                                <td __designer:mapid="8c6">
                                    <table class="style1" __designer:mapid="8c7">
                                                        ...
                                                        <td style="width: 400px" valign="top">
                                                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="cantBodPaisProducto" HeaderText="Cantidad">
                                                            ...
                                                            <asp:Panel ID="Panel6" runat="server">
                                                                <asp:MultiView ID="MultiView1" runat="server">
                                                                        ...
                                                                        <asp:Panel ID="Panel3" runat="server" Height="400px" ScrollBars="Vertical">
                                                                            <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" 
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundField DataField="cantDetPedProductoBod" DataFormatString="{0:N0}" 
                                                                                        HeaderText="Cantidad">
                                                                                    <ItemStyle HorizontalAlign="Right" />
                                                                                    </asp:BoundField>
                                                                                </Columns>
                                                                    ...
                                                                    <asp:View ID="View3" runat="server">
                                                                        <asp:Panel ID="Panel4" runat="server" Height="500px" ScrollBars="Both">
                                                                            <table class="style1">
                                                                                <tr>
                                                                                    <td align="center" 
                                        ...
                                        <tr __designer:mapid="939">
                                            <td __designer:mapid="93a" colspan="2">
                                                &nbsp;</td>
                                        </tr>
                                        <tr __designer:mapid="939">
                                            <td class="style2" __designer:mapid="93a">
