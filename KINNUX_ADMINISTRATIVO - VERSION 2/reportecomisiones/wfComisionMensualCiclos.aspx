...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <tr>
        <td class="titleseccion"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="90%">Comisiones Mensuales Ciclos</td>
            </tr>
          </table>
          </td>
      </tr>
                ...
                <table cellpadding="0" cellspacing="0" class="style1">
                    ...
                    <tr>
                        ...
                        <td class="auto-style3">
                            <asp:DropDownList ID="DropDownList14" runat="server" AutoPostBack="True" CssClass="campver" Width="350px">
                            </asp:DropDownList>
                            <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Text="Mostrar Sucursal" />
                            </td>
                    </tr>
                    <tr>
                        <td class="auto-style2">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownList15" runat="server" CssClass="campver" Width="350px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
    ...
    CellPadding="3" AutoGenerateColumns="False" ShowFooter="True" ShowHeaderWhenEmpty="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="bono1comisionvp" HeaderText="Bono 1" 
                                DataFormatString="{0:N2}" >
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
