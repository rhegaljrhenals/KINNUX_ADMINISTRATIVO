...
Partial Class Reportes_Varios_wfComisionMensualCiclos
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        If Me.DropDownList13.SelectedIndex = 0 Or Me.DropDownList12.SelectedIndex = 0 Then
            Me.Label4.Text = "ERROR: Seleccione el periodo correctamente...!"
            Exit Sub
        End If
        ' 
        If Me.DropDownList14.SelectedIndex = 0 Or Me.DropDownList14.SelectedIndex = -1 Then
            Me.Label4.Text = "ERROR: Seleccione la empresa...!"
            Exit Sub
        End If
        '
        If Me.CheckBox1.Checked = True Then
            If Me.DropDownList15.SelectedIndex = 0 Or Me.DropDownList15.SelectedIndex = -1 Then
                Me.Label4.Text = "ERROR: Seleccione la sucursal...!"
                Exit Sub
            End If
        End If
        '
    ...
    Sub cargarSucursales()
        ...
        With sucursales
            ...
            If tabla.Rows.Count <> 0 Then
                Me.DropDownList15.DataSource = tabla
                Me.DropDownList15.DataTextField = "nombreSucursal"
                Me.DropDownList15.DataValueField = "idSucursal"
                Me.DropDownList15.DataBind()
            Else
                Me.DropDownList15.DataSource = Nothing
                Me.DropDownList15.DataBind()
            End If
            Me.DropDownList15.Items.Insert(0, "Seleccione Sucursal")
        End With
    End Sub
