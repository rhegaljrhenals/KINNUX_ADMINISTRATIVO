                ...
                <table cellpadding="0" cellspacing="0" class="style1">
                    ...
                    <tr>
                        <td class="auto-style1">
                            Empresa:</td>
                        <td>
                            <asp:DropDownList ID="DropDownList14" runat="server" CssClass="campver" Width="300px" AutoPostBack="True">
                            </asp:DropDownList>
                            <asp:CheckBox ID="CheckBox1" runat="server" Text="Mostrar Las Sucursales" AutoPostBack="True" />
                            </td>
                    </tr>
                    <tr>
                        <td class="auto-style1">
                        ...
                        <td>
                            <asp:Panel ID="Panel2" runat="server">
                                <table class="auto-style4">
                                    ...
                                    <tr>
                                        <td class="auto-style6">Sucursales:</td>
                                        <td class="auto-style7">
                                            <asp:DropDownList ID="DropDownList15" runat="server" Width="350px" CssClass="campver">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
